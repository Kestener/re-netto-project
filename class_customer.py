...
##############################
    ...
    def move(self):
        if self.active:
            possible_locations = ["checkout","dairy","drinks","entrance","fruit","spices"]
            probs = {"checkout" : [1, 0, 0, 0, 0, 0],
            ...
            new_location = np.random.choice([0,1,2,3,4,5],p=probs[self.location])
            new_location = possible_locations[new_location]
